...
3. 운영팀 안내 또는 외부 결제 페이지에서 결제 완료
4. 결제 확인 후 "내 강의실"에서 VOD 시청
5. 모든 차시 완료 시 수료증 자동 발급

## 결제 안내
- 결제는 운영팀 안내 또는 외부 결제 페이지를 통해 진행
- 쿠폰/할인 조건은 결제 안내 시 확인
...
const FALLBACK_RULES: FallbackRule[] = [
  {
    ...
    answer:
      '수강 방법은 간단합니다!\n\n1️⃣ "강의 탐색" 메뉴에서 원하는 강의를 선택하세요.\n2️⃣ 강의 상세 페이지에서 "수강 신청" 버튼을 클릭하세요.\n3️⃣ 운영팀 안내 또는 외부 결제 페이지에서 결제를 완료하세요.\n4️⃣ 결제 확인 후 "내 강의실"에서 바로 VOD 시청이 가능합니다.\n5️⃣ 모든 차시를 완료하면 수료증이 자동 발급됩니다.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "결제 관련 안내드립니다.\n\n현재 결제는 운영팀 안내 또는 외부 결제 페이지를 통해 진행됩니다. 강의 상세 페이지에서 수강 신청을 남겨주시면 결제 및 수강 절차를 안내드립니다.\n\n결제 오류가 발생한 경우, 하단 채널톡 버튼으로 고객센터에 문의해 주세요.",
  },
  {
    keywords: ["환불", "취소", "철회"],
    answer:
