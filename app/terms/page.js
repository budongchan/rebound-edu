  ...
  return (
    <LegalShell title="이용약관" updated="2026년 6월 2일">
      ...
      <Article heading=”제2조 (정의)”>
        <p>”강의”란 회사 또는 등록 전문가가 서비스를 통해 제공하는 교육 상품을 말하며, 온라인 콘텐츠와 오프라인 현장 특강(이하 “오프라인 특강”)을 모두 포함합니다.</p>
        <p>”온라인 콘텐츠”란 인터넷을 통해 제공되는 녹화·실시간 강의 등 디지털 교육 콘텐츠를 말합니다.</p>
        <p>”오프라인 특강”이란 지정 장소에서 강사가 직접 진행하는 현장 교육 과정을 말합니다.</p>
        <p>”이용자”란 본 약관에 따라 서비스를 이용하는 회원 및 비회원을 말합니다.</p>
      </Article>
      <Article heading="제3조 (결제 및 수강)">
        <p>유료 강의의 결제는 계좌이체(무통장입금) 등 회사가 제공하는 결제수단을 통해 이루어집니다.</p>
