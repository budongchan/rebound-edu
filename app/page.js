        ...
        <section className="bg-paper py-20">
          <div className="container-edu">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {WHY.map((w, i) => (
                <div key={i} className="group rounded-2xl border border-line bg-paper p-7 shadow-[0_16px_38px_-30px_rgba(20,17,15,0.42)] transition-shadow hover:shadow-md">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-brand text-white shadow-[0_10px_24px_-14px_rgba(0,0,0,0.7)]">
                      {w.icon}
                  </div>
                  <h3 className="mt-5 text-[18px] font-extrabold leading-snug text-ink">{w.title}</h3>
