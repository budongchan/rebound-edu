...
export const EDU_SERVICE = {
  ...
  targetSelect:
    "id,order_id,course_id,buyer_name,buyer_email,buyer_phone,depositor_name,amount,status,created_at,deposit_valid_until,deposit_confirmed_at,paid_at,course_title",
  targetIdColumn: "id",
