...
export const CATEGORIES = [
  ...
  { key: "vacancy", label: "공실·사업장", color: "#0f766e" },
  { key: "brokerage", label: "중개업", color: "#2563eb" },
  { key: "lodging", label: "숙박업", color: "#b45309" },
  { key: "ai", label: "AI자동화", color: "#7c3aed" },
  { key: "investment", label: "투자개발", color: "#e63329" },
];
